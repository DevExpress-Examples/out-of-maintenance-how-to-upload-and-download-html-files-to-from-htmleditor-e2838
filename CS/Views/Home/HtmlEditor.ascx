    ...
    Html.DevExpress().HtmlEditor(
        settings => {
            ...
            Action<object, DevExpress.Web.ASPxFileManager.FileManagerActionEventArgsBase> editHandler = (sender, e) => {
                ((DevExpress.Web.ASPxFileManager.FileManagerActionEventArgsBase)e).Cancel = true;
                ((DevExpress.Web.ASPxFileManager.FileManagerActionEventArgsBase)e).ErrorText = "Error Text";
            };
